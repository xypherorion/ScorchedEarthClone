...
{
    public class DroppingBomb : ShooterLogic
    {
        ...
        public override void Fire()
        {
            base.Fire();
            StartWeaponTimer();
            StartCoroutine(RunEndlessAfterDelay(0.5f, 0.2f, InitiateSplitBomb));
        ...
        private void InitiateSplitBomb()
        {
            ...
            var weapon = WeaponController.WeaponInventory.GetWeaponInstance(WeaponType.DroppingBomb, position);
            var component = weapon.GameObject.GetComponent<DroppingBomb>();
